--- inc_api policies
grant usage on schema inc_api to anon, authenticated, service_role;
grant all on all tables in schema inc_api to anon, authenticated, service_role;
grant all on all routines in schema inc_api to anon, authenticated, service_role;
grant all on all sequences in schema inc_api to anon, authenticated, service_role;
alter default privileges for role postgres in schema inc_api grant all on tables to anon, authenticated, service_role;
alter default privileges for role postgres in schema inc_api grant all on routines to anon, authenticated, service_role;
alter default privileges for role postgres in schema inc_api grant all on sequences to anon, authenticated, service_role;
